...
!
!
! needs input file JLepsinvomega.inp containing the file name of the chi file
!===============================================================================
...
program jl_readchi
  ...
  character*256, parameter :: fninp = "jl_readchi.inp"
...
!-----------------------------
  ...
  call open_file(unit=7,file='nmtx.dat',form='formatted',status='replace')
